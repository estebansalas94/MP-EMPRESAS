...
const CategoriaUpdate = () => {
    ...
    const submitUpdate = async (e) => {
        e.preventDefault();
        try {
            const response = await Config.getCategoriaUpdate({aprobado},id);
                        ...
                        <div className="card-body">
                            <form onSubmit={submitUpdate}>
                                <div className="col-sm-12">
                                    ...
                                    <input type="text" className="form-control" id="name" value={nombre} onChange={(e)=>setName(e.target.value)}/>
                                </div>
